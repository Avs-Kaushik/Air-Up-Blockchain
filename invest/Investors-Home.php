        ...
        <div class="box box2">
          <div class="temp">
            <div class="navi">
                ...
                <div class="na na6"><a id="naa" href="logout.php"><img src="avatar.png" height="40px" width="40px"></a><!--php--></div>
                <?php }?>
              </div>
            </div>
        </div>
...
<div class="io">
  ...
  <div class="irt">
    ...
    <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp;<button onclick="go()" class="topbt">Learn  More</button>
  </div>
  </div>
...
<div class="columns">
  <div class="c1">
      <div class="c1t">
        <br>
        <div class="c1t1"><h3>AirUp</h3></div>
...
<script>
  function go()
  { 
window.location = "http://localhost/AIRUP/New%20Folder/t.php";  
  }
</script>