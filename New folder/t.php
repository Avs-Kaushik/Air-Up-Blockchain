        ...
        <div class="box box2">
          <div class="temp">
            <div class="navi">
                ...
                <div class="na na6"><a id="naa" href="http://localhost/AIRUP/scroll/ilogin.php"><button class="lbt "><span id="naa2">Login</span></button></a></div>
                <?php }
                else {?>
                <div class="na na6"><a id="naa" href="http://localhost/AIRUP/invest/logout.php"><img src="avatar.png" height="40px" width="40px"></a><!--php--></div>
                <?php }?>
              </div>
            </div>
        </div>
        ...
        <div class="about">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-img" data-parallax="scroll" data-image-src="https://img.freepik.com/free-vector/startup-construction-development-3d-thin-line-art-style-design-concept-isometric-illustration_1284-61110.jpg?w=740&t=st=1707326229~exp=1707326829~hmac=766b6028ede1bdf432d987655b94e65c86ddcc5c74a95be23c2ea823192f89d5"></div>
                    </div>
                    <div class="col-lg-6">
...
.
        ...
        <!-- About End -->
        <!-- Facts Start -->
        <div class="facts" data-parallax="scroll" data-image-src="https://img.freepik.com/free-vector/people-starting-business-project_23-2148866842.jpg?w=900&t=st=1707326743~exp=1707327343~hmac=6742306b6aaf475f3de847f6d7d0c693cc4083a47323b7bbebba2f810480291f">
            <div class="container">
                <div class="row">
        ...
        <div class="causes">
            <div class="container">
                ...
                if (mysqli_num_rows($res) > 0) {
                    $c=0;
                    $imgs=["hel.jpg","hem.jpg","hen.jpg","facts.jpg","hel.jpg","hem.jpg","hen.jpg","facts.jpg"];
