        ...
        <div class="box box2">
          <div class="temp">
            <div class="navi">
                ...
                <div class="na na5"><a id="naa" href="http://localhost/AIRUP/form/courses.php">Hacakthons</a></div>
                <div class="na na3"><a id="naa" href="http://localhost/AIRUP/support/sup.php">Contact</a></div>
                <div class="na na4"><a id="naa" href="http://localhost/AIRUP/getairup/">About</a></div>
                <?php if (empty($_SESSION["uname"])) {?>
                <div class="na na6"><a id="naa" href="g.php"><button class="lbt"><span id="naa2">Login</span></button></a></div>
                <?php }
                else {?>
                <div class="na na6"><a id="naa" href="pf.php"><img src="avatar.png" height="40px" width="40px"></a><!--php--></div>
                <?php }?>
              </div>
            </div>
        </div>
...
<div class="mySlides fade">
  <img class="img1" src="https://elements-cover-images-0.imgix.net/db1ab058-fda7-498d-aea0-1d0d5d01b5fb?auto=compress%2Cformat&w=1370&fit=max&s=30ccd3ffbd64c82a35b2d05e6bcb0a67"height="500px" width="900px " >
  <div class="afterimg1">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<br><br>
<a href="http://localhost/AIRUP/support/sup.php"><button style="border:none; height:20px; border-radius:10px; 
...
<div class="mySlides fade">
  <img class="img1"src="ig2.jpg" height="500px" width="900px ">
  <div class="afterimg2">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<br><br>
<a href="http://localhost/AIRUP/support/sup.php"><button style="border:none; padding:10px;height:40px; border-radius:10px; 
...
<div class="mySlides fade">
  <img class="img1"src="ig3.jpeg"  height="500px" width="900px ">
  <div class="afterimg3">
  <div class="b3">
    Innovate
  </div >
...
<div class="intxt">
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 &nbsp;
<a href="http://localhost/AIRUP/form/idea_sub.php"><button class="btt">Submit Now</button></a>
